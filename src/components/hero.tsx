  ...
  return (
    <div className="hero-container">
      <div className="hero-content">
        ...
        <motion.div className="hero-image-main" animate={{ y: [0, -10, 0] }} transition={{ duration: 2, repeat: Infinity }}>
        ...
        <motion.div className="hero-image-top" animate={{ x: [0, 10, 0] }} transition={{ duration: 2, repeat: Infinity }}>
        ...
        <motion.div className="hero-image-bottom" animate={{ x: [0, -10, 0] }} transition={{ duration: 2, repeat: Infinity }}>
