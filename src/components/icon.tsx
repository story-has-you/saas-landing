...
const Google: React.FC<IconProps> = ({ size = 24, className = "", ...props }) => {
  return (
    <svg width={size} height={size} className={className} viewBox="0 0 24 24" {...props}>
...
const GitHub: React.FC<IconProps> = ({ size = 24, className = "", ...props }) => {
  return (
    <svg role="img" width={size} height={size} className={className} viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" {...props}>
      <title>GitHub</title>
...
const AcmeCorp: React.FC<IconProps> = ({ size = 24, className = "", ...props }) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} className={className} {...props}>
      <g>
...
export { AcmeCorp, Apex, Celestial, EchoValley, GitHub, Google, Logo };
